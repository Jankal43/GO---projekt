class triangleCar {
  ...
  void drawBox(float w, float h, float d) {
    ...
    float y = h / 2;
    float z = d / 2;
    int divisions = 4; // Liczba podziałów w jednej osi
...
class DelaunayTriangulation {
    ...
    DelaunayTriangulation(ArrayList<Vec2D> points) {
        ...
        // Usuwanie trójkątów, które zawierają wierzchołki trójkąta okalającego
        //triangles.removeIf(triangle -> triangle.containsAny(superTriangle.vertices));
    }
